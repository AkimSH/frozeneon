...
<form action="/registration" enctype="multipart/form-data" method="post">
    ...
    <div class="container">
        ...
        <label for="personaname"><b>Username</b></label>
        <input type="text" placeholder="Enter Username" name="personaname" required>

        <label for="avatarfull"><b>Uploade avatar</b></label>
        <fieldset>
            <input type="file" name="avatarfull"/>
        </fieldset>
            <br><br>
