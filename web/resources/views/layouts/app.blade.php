                        ...
                        <div class="card-body">
                            ...
                            {{--<div v-for="comment in post.coments">
                                ...
                                <div v-if="comment.replies">
                                    ...
                                    reply for comment
                                    <div v-for="replie in comment.comments">
                                        <p class="card-text">
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js"
        ...
        crossorigin="anonymous"></script>
<script src="{{ asset('js/app.js') }}?v=1234567725566115325"></script>
</body>
</html>
                    ...
                    <div class="col-4" v-for="post in posts" v-if="posts">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-outline-success my-2 my-sm-0" @click="openPost(post.id)">Open post</button>
                            </div>
                        </div>
                    </div>
                </div>
